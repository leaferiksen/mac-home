...
(use-package agent-shell
  ...
  :custom (agent-shell-google-authentication
		   (agent-shell-google-make-authentication :login t)
		   (agent-shell-qwen-make-authentication :login t))
  :bind (("C-c a" . agent-shell-add-region)
...
(use-package emacs
  ...
  :custom-face
  (default ((t (:family "Maple Mono NF CN" :height 160))))
  (variable-pitch ((t (:family "New York" :height 220))))
...
(use-package markdown-mode
  ...
  :custom-face
  (markdown-link-face ((t (:underline nil :inherit link))))
  (markdown-code-face ((t (:family "Maple Mono NF CN" :inherit default))))
