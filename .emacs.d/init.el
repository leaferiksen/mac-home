...
(use-package emacs
  ...
  :custom-face (default ((t (:family "New York" :height 180)))) (variable-pitch ((t (:family "New York" :height 180)))) (fixed-pitch ((t (:family "Maple Mono NF CN" :height 160))))
  :custom ((apheleia-global-mode t)
		   ...
		   (package-selected-packages '(apheleia eglot elfeed elfeed-webkit emmet-mode emojify esxml exec-path-from-shell fixed-pitch flexoki-themes flymake-eslint jinx lorem-ipsum lsp-mode lsp-tailwindcss lua-mode minesweeper minions mpv nerd-icons-dired nov obsidian snow spacious-padding swift-mode treesit-langs undo-fu valign visual-fill-column yasnippet))
