...
brew install --cask anki calibre font-maple-mono-nf-cn font-symbols-only-nerd-font ghostty hammerspoon homerow iina knockknock modrinth notunes osu qlmarkdown qlvideo Sikarugir-App/sikarugir/sikarugir soulver steam syncthing tor-browser virtualbuddy waterfox zotero
