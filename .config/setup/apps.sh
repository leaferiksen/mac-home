...
brew install --cask anki calibre font-atkinson-hyperlegible-next font-atkinson-hyperlegible-mono font-maple-mono-nf-cn font-symbols-only-nerd-font ghostty hammerspoon homerow iina knockknock lunar modrinth notunes osu qlmarkdown qlvideo Sikarugir-App/sikarugir/sikarugir soulver steam syncthing tor-browser virtualbuddy waterfox zotero
