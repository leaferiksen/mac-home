...
brew install --cask anki calibre darrylmorley/whatcable/whatcable font-atkinson-hyperlegible-next font-maple-mono-cn font-symbols-only-nerd-font homerow iina knockknock modrinth mos@beta neodisk osu soulver superwhisper syncthing transmission virtualbuddy zotero
