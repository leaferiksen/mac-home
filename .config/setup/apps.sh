...
brew install --formula aspell ffmpeg media-info pandoc pngpaste tealdeer typst yqrashawn/goku/goku yt-dlp zig zsh-autosuggestions zsh-syntax-highlighting 
