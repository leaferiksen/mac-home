...
brew install --cask --no-quarantine font-atkinson-hyperlegible font-open-dyslexic font-red-hat-mono sanesidebuttons topnotch aldente maccy lunar music-decoy iina handbrake proton-pass obsidian librewolf thunderbird@esr zotero affinity-designer calibre soulver anki itch steam whisky heroic modrinth utm webstorm knockknock
# vlc chromium zen-browser porting-kit crossover diffusionbee
