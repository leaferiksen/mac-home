...
brew install --cask --no-quarantine anki calibre chromium font-atkinson-hyperlegible-mono font-atkinson-hyperlegible-next font-red-hat-mono ghostty iina itch knockknock loop maccy notunes obsidian osu qbittorrent@lt20 soulver steam utm virtualbuddy zen-browser zotero
