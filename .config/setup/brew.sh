...
brew install --formula duti eza ffmpeg jackett koekeishiya/formulae/skhd lazygit less mas tailwindcss tlrc yt-dlp zsh-autosuggestions zsh-syntax-highlighting
