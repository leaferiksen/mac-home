...
brew install --formula eza ffmpeg fswatch koekeishiya/formulae/skhd lazygit less mas nano tailwindcss tlrc yt-dlp zsh-autosuggestions zsh-syntax-highlighting
