...
brew install --formula duti emacs-plus@30 eza ffmpeg jackett koekeishiya/formulae/skhd mas tailwindcss tealdeer yt-dlp zsh-autosuggestions zsh-syntax-highlighting
