...
# brew uninstall --formula deno tailwindcss
# brew uninstall --cask --zap modrinth affinity-designer thunderbird@esr libreoffice handbrake vlc zen-browser porting-kit crossover diffusionbee lunar topnotch whisky heroic
