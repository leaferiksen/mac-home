...
brew install --formula duti eza fastfetch ffmpeg fswatch jackett koekeishiya/formulae/skhd lazygit less mas nano tailwindcss tlrc yt-dlp zsh-autosuggestions zsh-syntax-highlighting
